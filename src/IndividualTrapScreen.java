...
public class IndividualTrapScreen extends JPanel implements ActionListener {
	...
	public IndividualTrapScreen(MainWindow window, int index) {
		this.window = window;
		...
		this.add(new IndividualTrapContent(window, index), BorderLayout.CENTER);
	}
	...
	private JPanel createHeader(){
		...
		String titleText = "Individual Trap";
